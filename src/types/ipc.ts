...
export const IPC = {
  ...
  WORKFLOWS_PREPARE_RUN: 'workflows:prepare-run',
  // Knowledge refinery
  REFINERY_SOURCES_LIST: 'refinery:sources:list',
  REFINERY_SOURCES_READ: 'refinery:sources:read',
  REFINERY_SOURCES_PREVIEW: 'refinery:sources:preview',
  REFINERY_SOURCES_IMPORT: 'refinery:sources:import',
  REFINERY_SOURCES_DELETE: 'refinery:sources:delete',
  REFINERY_JOBS_LIST: 'refinery:jobs:list',
  REFINERY_JOBS_READ: 'refinery:jobs:read',
  REFINERY_JOBS_CREATE_FROM_SOURCE: 'refinery:jobs:create-from-source',
  REFINERY_JOBS_CREATE_FROM_CONVERSATION: 'refinery:jobs:create-from-conversation',
  REFINERY_JOBS_CANCEL: 'refinery:jobs:cancel',
  REFINERY_JOBS_RETRY: 'refinery:jobs:retry',
  REFINERY_JOBS_DELETE: 'refinery:jobs:delete',
  REFINERY_JOBS_DEBUG: 'refinery:jobs:debug',
  REFINERY_CANDIDATES_PAGE: 'refinery:candidates:page',
  REFINERY_CANDIDATES_READ: 'refinery:candidates:read',
  REFINERY_CANDIDATES_UPDATE: 'refinery:candidates:update',
  REFINERY_CANDIDATES_APPLY: 'refinery:candidates:apply',
  REFINERY_CHANGED: 'refinery:changed',
