...
export function TargetsTab() {
  ...
  if (visibleNodes.length === 0) {
    return (
      <div className="flex h-full flex-col items-center justify-center p-4 text-text-muted">
        <div className="mb-3 flex h-11 w-11 items-center justify-center rounded-full border border-border-subtle bg-panel">
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="shrink-0 border-b border-border-subtle !bg-panel/50 px-3 py-2 text-2xs text-text-muted">
      ...
      <div className="flex-1 overflow-y-auto">
        {visibleNodes.map((node) => {
          ...
          <button
            ...
            className={`w-full border-b border-border-subtle/50 px-3 py-2 text-left transition-colors hover:bg-raised/30 ${
...
function NodeDetailPanel({ nodeId }: { nodeId: string }) {
  ...
  return (
    <div className="max-h-72 shrink-0 overflow-y-auto border-t border-border-subtle bg-panel/50">
      <div className="flex items-center justify-between border-b border-border-subtle/50 px-3 py-2">
      ...
      <div className="space-y-2 p-3 text-2xs">
        ...
        />
        {target && <div className="border-t border-border-subtle/70 pt-2">
          ...
          {openPorts.length > 0 ? (
            ...
            <div className="rounded border border-dashed border-border-subtle px-2 py-3 text-center text-text-muted">
