...
describe('AI asset registration', () => {
  ...
  let syncTargetsService: typeof import('./sync-targets.service').syncTargetsService;
  ...
  beforeAll(async () => {
    ...
    vi.resetModules();
    sessionService = (await import('./session.service')).sessionService;
    syncTargetsService = (await import('./sync-targets.service')).syncTargetsService;
