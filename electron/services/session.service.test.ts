...
describe('folder project service', () => {
  ...
  let sessionService: typeof import('./session.service').sessionService;
  let isVisibleSessionFileChange: typeof import('./session.service').isVisibleSessionFileChange;
  let resolveProjectWatchPath: typeof import('./session.service').resolveProjectWatchPath;
  ...
  beforeAll(async () => {
    ...
    vi.resetModules();
    const sessionModule = await import('./session.service');
