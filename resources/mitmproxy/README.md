...
Packaged Hexestra builds include the official platform-specific mitmdump 12.2.3
runtime and load `hexestra_addon.py` as a project-local sidecar addon. The runtime
...
Source runs may use an operator-installed compatible executable. A path selected in
